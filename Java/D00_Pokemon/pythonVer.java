...
//        # class field
//
//class Java_Network.po.Pokemon:
//        count = 0
//        def __init__(self, owner, skills):
//        self.__hidden_owner = owner  # like private
//        self.skills = skills.split('/')
//                print(f"포켓몬 생성 :", end=' ')
//                Java_Network.po.Pokemon.count = Java_Network.po.Pokemon.count + 1
//
//@property
//    def owner(self):
...
//
//
//class Pikachu(Java_Network.po.Pokemon):  # inheritance
//        def __init__(self, owner, skills):
...
//
//
//class Ggoboogi(Java_Network.po.Pokemon):  # inheritance
//        def __init__(self, owner, skills):
//        super().__init__(owner, skills)
//        self.name = "꼬부기"
//        print(f"{self.name}")
...
//
//
//class Pairi(Java_Network.po.Pokemon):  # inheritance
//        def __init__(self, owner, skills):
//        super().__init__(owner, skills)
//        self.name = "파이리"
//        print(f"{self.name}")
...
//
//        while True:
//        print(f'총 {Java_Network.po.Pokemon.count}마리의 포켓몬이 생성되었습니다')
